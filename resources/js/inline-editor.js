...
class InlinePageEditor {
    ...
    translateFieldName(field) {
        const translations = {
            ...
            'background_style': 'Achtergrondstijl',
            'background_class': 'Achtergrondstijl',
            'max_width': 'Maximale breedte',
            'padding_class': 'Binnenmarges',
            'alt_text': 'Alt-tekst',
            'caption': 'Bijschrift',
            'images': 'Afbeeldingen',
            'columns': 'Kolommen',
            ...
            'right_variant': 'Rechter variant',
            'right_title': 'Rechter titel',
            'right_subtitle': 'Rechter subtitel',
            'right_button_text': 'Rechter knoptekst',
            'right_button_link': 'Rechter knoplink',
            'right_image': 'Rechter afbeelding',
            'right_image_alt': 'Rechter afbeelding alt',
            'icon': 'Icoon',
            'url': 'URL',
            'alt': 'Alt',
        };
